package com.amsavarthan.apps.media_toolbox.adapters;
...
import com.amsavarthan.apps.media_toolbox.activities.VideoDownloaderDialogActivity;
...
import static com.amsavarthan.apps.media_toolbox.activities.RepostActivity.formatFileSize;
...
public class SingleVideoAdapter extends RecyclerView.Adapter<SingleVideoAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SingleVideoAdapter.ViewHolder holder, int i) {
